		...
		if (isInteger(input))
		{
			...
			case 1:
				for (int flag_1 = 1; flag_1 != 0;)
				{
					...
					char input_1[100] = { '0' };
					scanf("%s", input_1);
					if (isInteger(input_1))
					{
						int t_1 = atoi(input_1);
						...
						case 1:
							...
							if (compare_u(p_head_u, name, &p_u_current))//compare the user's name and password
							{
								...
								for (int flag_2 = 1; flag_2 != 0;)
								{
									...
									char input_2[100] = { '0' };
									scanf("%s", input_2);
									if (isInteger(input_2))
									{
										int t_2 = atoi(input_2);
										...
										case 1:
											for (int flag_3 = 1; flag_3 != 0;)
											{
												...
												char input_3[100] = { '0' };
												scanf("%s", input_3);
												if (isInteger(input_3))
												{
													int t_3 = atoi(input_3);
													...
													case 1:
														...
														if (m_current != NULL)
														{
															...
															for (int flag_4 = 1; flag_4 != 0;)
															{
																...
																char input_4[100] = { '0' };
																scanf("%s", input_4);
																if (isInteger(input_4))
																{
																	int t_4 = atoi(input_4);
																	...
																	case 1:
																		for (int flag_5 = 1; flag_5 != 0;)
																		{
																			...
																			char input_5[100] = { '0' };
																			scanf("%s", input_5);
																			if (isInteger(input_5))
																			{
																				int t_5 = atoi(input_5);
																				...
																				case 1:
																					for (int flag_6 = 1; flag_6 != 0;)
																					{
																						...
																						char input_6[100] = { '0' };
																						scanf("%s", input_6);
																						if (isInteger(input_6))
																						{
																							int t_6 = atoi(input_6);
												...
												case 2:
													for (int flag_5 = 1; flag_5 != 0;)
													{
														...
														case 1:
															...
															{
																printf("We don't have the recipe class you want\n");
																sleep();
																delete_several_lines(1);
																fflush(stdout);
															}
