...
void output_recipe_high_to_low(r_classify* r_classify_head, float min_price, float max_price)
{
    ...
    while (current_classify != NULL)
    {
        ...
        recipe* new_recipe_ListHead = NULL;
        recipe* new_recipe_ListTail = NULL;
...
void output_recipe_low_to_high(r_classify* r_classify_head, float min_price, float max_price)
{
    if (r_classify_head == NULL)
    {
        colour(12);
